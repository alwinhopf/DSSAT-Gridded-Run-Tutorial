...
from weather_daymet        import process_weather_daymet
from weather_nasapower     import process_weather_nasapower
from weather_gridmet       import process_weather_gridmet
from weather_openmeteo     import process_weather_openmeteo
from weather_nasapower_chirps import process_weather_nasapower_chirps
from weather_agera5        import process_weather_agera5
from soil_ssurgo           import process_soils_ssurgo
from soil_soilgrids        import process_soils_soilgrids
from soil_soilgrids_online import process_soils_soilgrids_online
from soil_hwsd             import process_soils_hwsd
...
if RUN_STEP_1_SOILS:
    ...
    if SOIL_SOURCE == "SSURGO":
        ...
        import soil_soilgrids_online as _sg_mod
...
if RUN_STEP_2_WEATHER:
    ...
    if points_to_process.empty:
        ...
        if WEATHER_SOURCE == "DAYMET":
            ...
            import weather_nasapower_chirps as _wc
