...
| 2 | ✅ **Done — dependency versions are recorded** in `dssatengine/DEPENDENCIES.md` and committed manifests. Consumers pin `dssatutils` commit `c189ffdb58f53f07f58b919ec04e8fe6fa958916` (v0.4.0 plus the GridMET thread-safety fix) and the verified `dssatengine` 0.4.0 commit `be06ba0268d51dd1ec6f6baa62ea5ed7869165a9`; `USE_LOCAL_SHARED_PACKAGES=1` opts into sibling checkouts for development. | Makes results reproducible and upgrades deliberate. | Low (done) |
