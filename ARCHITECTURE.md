...
| 2 | ✅ **Done — dependency versions are recorded** in `dssatengine/DEPENDENCIES.md` and committed manifests. Consumers pin `dssatutils@v0.4.0` and the verified `dssatengine` 0.4.0 commit `be06ba0268d51dd1ec6f6baa62ea5ed7869165a9`; `USE_LOCAL_SHARED_PACKAGES=1` opts into sibling checkouts for development. | Makes results reproducible and upgrades deliberate. | Low (done) |
